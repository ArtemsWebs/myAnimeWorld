...
export const LicensorModel = t.Object({
  ...
  licensorsAnimeId: t.Optional(t.String()),
});
...
export const InternalTrailerImagesModel = t.Object({
  ...
  large_image_url: t.String(),
  small_image_url: t.String(),
  medium_image_url: t.String(),
  maximum_image_url: t.String(),
});
...
export const AnimeModelBase = t.Object({
  ...
  genres: t.Array(GenresModel),
  licensors: t.Array(LicensorModel),
  producers: t.Array(ProducerModel),
  studios: t.Array(StudioModel),
});
